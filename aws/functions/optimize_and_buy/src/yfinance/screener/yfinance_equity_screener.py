...
def screen_equities(
    min_eod_price: float | None = None,
    max_eod_price: float | None = None,
    region: str = "us",
    exchange: Sequence[str] | None = None,
    industry: str | None = None,
    sector: str | None = None,
    min_avg_volume: int | None = 100_000,
    min_market_cap: float | None = 300_000_000,
    limit: int = 200,
) -> list[dict[str, Any]]:
    try:
...
def enrich_results_with_info(
    results: list[dict[str, Any]], fields: Sequence[str] = ("sector", "industry", "eodprice")
) -> list[dict[str, Any]]:
    try:
        import yfinance as yf
    except Exception:
...
def save_results_csv(results: list[dict[str, Any]], filename: str | None = None) -> Path:
...
if __name__ == "__main__":
    print(
        "Running example screener: Technology sector, price 5-500 USD, region=us, min_avg_volume=100000, min_market_cap=300000000\n"
    )
